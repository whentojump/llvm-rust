...
# NOTE this script looks tempting at first glance
#      but `AvailableComponents` array is indeed generated elsewhere
#      this script perhaps never gets executed
...
{ "innerunikernels", "LLVMInnerUnikernels", true, {"analysis", "core", "support", "transformutils"} },
...
{ "passes", "LLVMPasses", true, {"aggressiveinstcombine", "analysis", "core", "coroutines", "ipo", "instcombine", "objcarcopts", "scalaropts", "support", "target", "transformutils", "vectorize", "instrumentation", "innerunikernels"} },
